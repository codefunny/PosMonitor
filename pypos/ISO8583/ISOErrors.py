...
class ValueToLarge(ISOError,Exception):
...
class BitInexistent(ISOError,Exception):
...
class InvalidValueType(ISOError,Exception):
...
class InvalidBitType(ISOError,Exception):
...
class InvalidIso8583(ISOError,Exception):
...
class InvalidMTI(ISOError,Exception):
...
class BitNotSet(ISOError,Exception):
